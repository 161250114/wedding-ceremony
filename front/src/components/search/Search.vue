        ...
        <el-card class="box-card">
            ...
            <ul>
                <li style="margin-bottom: 30px"><strong style="font-weight: bolder">基本条件</strong>
                    ...
                    <el-select v-model="tallest_label" clearable placeholder="选择身高范围"
                               style="margin-left: 3px; width: 130px" @change="changeLocationValue_tallest">
                        <el-option v-for="item in height" :key="item.height_value"
                                   :label="item.height_label" :value="item.height_value">
                        </el-option>
                    </el-select>

                    <el-select v-model="lowest_label" clearable placeholder="选择月收入范围"
                               style="margin-left: 15px; margin-right:3px; width: 145px"
            ...
            <ul>
                <li style="margin-bottom: 20px"><strong style="font-weight: bolder">高级搜索</strong>
                    ...
                    <el-select v-model="nation_label" clearable placeholder="民族"
                               style="margin-left: 20px; width: 108px">
                        <el-option v-for="item in nation" :key="item.nation_value"
                                   :label="item.nation_label" :value="item.nation_value"></el-option>
                    </el-select>
                    ...
                    <el-select v-model="house_label" clearable placeholder="住房情况"
                               style="margin-left: 20px; width: 140px">
                        <el-option v-for="item in house" :key="item.house_value"
                                   :label="item.house_label" :value="item.house_value"></el-option>
                    </el-select>

                    <el-select v-model="child_label" clearable placeholder="有无子女"
                               style="margin-left: 20px; width: 158px">
                        <el-option v-for="item in child" :key="item.child_value"
                                   :label="item.child_label" :value="item.child_value"></el-option>
                    </el-select>
