<template>
    <div>
        ...
        <el-dialog style="" title="聊天室"  :close-on-click-modal="false"  :lock-scroll="false" :visible.sync="chatRoomVisible" width="40%" :before-close="handleClose">
            <ChatRoom></ChatRoom>
        </el-dialog>
        ...
        <el-card class="simpleInfo">
            ...
            <div style="margin-top: 20px">
                <el-button type="primary" plain @click="handleDisplay()" class="sayHi" style="margin-left: 40px">打招呼</el-button>
                <el-button type="primary" plain @click="handleChat()" class="sayHi" style="margin-left: 10px" :disabled="userState">发消息</el-button>
            </div>
        </el-card>

        <div class="show_detail" style="margin-top: 20px">
                    <el-card style="margin-bottom: 20px" shadow="false">
                        <li style="line-height: 10px; margin-bottom: 20px"><strong style="font-size: 20px; font-weight: bolder">内心独白</strong></li>
                        <p style="font-size: 18px; line-height: 8px">{{records.introduction}}</p>
                    </el-card>
                    <el-card  style="margin-bottom: 20px" shadow="false">
                        <li style="line-height: 10px; margin-bottom: 20px"><strong style="font-size: 20px; font-weight: bolder">个人资料</strong>
                        </li>
                    ...
                    <el-card  style="margin-bottom: 20px" shadow="false">
                        <li style="line-height: 10px; margin-bottom: 20px"><strong style="font-size: 20px; font-weight: bolder">择偶要求</strong>
                        </li>
                        <div style="line-height: 4px">
                    ...
                    <el-card  style="margin-bottom: 20px" shadow="false">
                        <li style="line-height: 10px; margin-bottom: 20px"><strong style="font-size: 20px; font-weight: bolder">兴趣爱好</strong>
                        </li>
                        <div style="line-height: 4px">
                    ...
                    <el-card  style="margin-bottom: 20px" shadow="false">
                        <li style="line-height: 10px; margin-bottom: 20px"><strong style="font-size: 20px; font-weight: bolder">生活方式</strong>
                        </li>
                        <div style="line-height: 4px">
